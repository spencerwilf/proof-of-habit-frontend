...
<>
  ...
  <dialog id="my_modal_1" className="fixed inset-0 p-6 bg-white rounded-lg shadow-lg z-50 mx-auto my-auto w-11/12 md:w-3/4 lg:w-1/2">
    ...
    <>
    {step === 1 && <><h3 className="font-bold text-lg mb-2">Create a new habit!</h3>
    <p className="py-4 mb-4 text-gray-700">Enter a title for your new habit.</p>
...
{hasSubmitted && errors.name && (<p className="text-red-500 text-sm mt-2" >{errors.name}</p>)}
...
>
  ...
  {step === 2 && 
  <>
    <h3 className="font-bold text-lg mb-2">Set your habit duration</h3>
    <p className="py-4 mb-4 text-gray-700">This is the number of days you intend to pursue your habit over <strong>(at least three)</strong>. Be sure to check in every day!</p>
    <div className="mb-4">
      <input 
        className="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 transition duration-300"
        value={duration} 
      ...
      {hasSubmitted && errors.duration && (<p className=" mt-2 text-red-500 text-sm">{errors.duration}</p>)}
    </div>
  ...
  {step === 3 && <><div className="mb-4">
    ...
    <p className="py-4 mb-4 text-gray-700">This is where your ETH will be transferred to should you fail your habit. <strong>Prevent this by checking in every day!</strong></p>
    <input 
      className="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 transition duration-300"
      value={lossAddress} 
    ...
    />
    {hasSubmitted && errors.lossAddress && (<p className="text-red-500 text-sm mt-2">{errors.lossAddress}</p>)}
 ...
 {step === 4 && <> <div className="mb-4">
   <h3 className="font-bold text-lg mb-2">Set your lockup value</h3>
    <p className="py-4 mb-4 text-gray-700">This is the ETH you're locking up until you complete your habit. You will either receive it back after you complete your habit or it will be transferred to the provided loss address should you fail.</p>
    <input 
      className="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 transition duration-300"
      value={value} 
   ...
   <div className="flex flex-col items-center">
     <h3 className="font-bold text-xl mb-6 ">Does everything look good?</h3>
     ...
     <div className="join py-6 px-4 rounded-b-xl w-3/5">
         <div className='flex flex-col gap-8 w-full'>
             ...
             <div className='flex justify-between items-center mb-4'>
                 ...
                 <p onClick={handleNameEdit} className=' text-md cursor-pointer hover:text-blue-500'>Edit</p>
             </div>
             ...
             <div className='flex justify-between items-center mb-4'>
                 ...
                 <p onClick={handleDurationEdit} className=' text-md cursor-pointer hover:text-blue-500'>Edit</p>
             </div>

             <div className='flex justify-between items-center mb-4'>
                 <div>
                     <p className=' text-xl mb-2'>Loss address</p>
                     <p className=' font-semibold text-lg'>{formatAddress(lossAddress)}</p>
                 </div>
                 <p onClick={handleLossAddressEdit} className=' text-md cursor-pointer hover:text-blue-500'>Edit</p>
             </div>
             ...
             <div className='flex justify-between items-center mb-4'>
                 ...
                 <p onClick={handleValueEdit} className=' text-md cursor-pointer hover:text-blue-500'>Edit</p>
             </div>
