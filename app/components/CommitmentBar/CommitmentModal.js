...
const CommitmentModal = () => {
  ...
  useEffect(() => {
    let errors = {};
    if (!isAddress(lossAddress))
      errors.lossAddress = "Please enter a valid address";
    if (Number(duration) < 3 || !isNumber(Number(duration)))
      errors.duration = "Please enter a duration three days or over.";
        ...
        {step === 2 && (
          <>
            ...
            <p className="py-4 mb-4 text-gray-700">
              ...
              <strong>(at least three)</strong>. Be sure to check in every day!
            </p>
            <div className="mb-4">
              <input
                className="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 transition duration-300"
              ...
              {hasSubmitted && errors.duration && (
                <p className="mt-2 text-red-500 text-sm">{errors.duration}</p>
              )}
            </div>
        ...
        {step === 4 && (
          <>
            <div className="mb-4">
              ...
              <p className="py-4 mb-4 text-gray-700">
                This is the ETH you're locking up until you complete your habit.
                You will either receive it back after you complete your habit or
                it will be transferred to the provided loss address should you
                fail.
              </p>
              <input
                className="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 transition duration-300"
